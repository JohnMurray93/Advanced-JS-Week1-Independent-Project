...
describe('AgeCalculator', function() {
  ...
  beforeEach(function() {
    reusableAgeCalculator = new AgeCalculator(25, "1993,3,3", 135);
  });
  ...
  it('should test that the AgeCalculator constructor works and accepts propper property types', function() {
    ...
    expect(reusableAgeCalculator.birthday).toEqual("1993,3,3");
    expect(reusableAgeCalculator.birthday).not.toEqual(1993,3,3);
